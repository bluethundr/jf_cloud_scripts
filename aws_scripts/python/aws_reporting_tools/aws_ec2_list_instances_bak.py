...
def initialize(interactive, aws_account):
    ...
    fieldnames = [ 'AWS Account', 'Account Number', 'Name', 'Instance ID', 'Volumes', 'Private IP', 'Public IP', 'Private DNS', 'Availability Zone', 'VPC ID', 'Type', 'Platform', 'Key Pair Name', 'State', 'Launch Date']
    # Set the input file
    aws_env_list = os.path.join('..', '..', 'output_files', 'aws_accounts_list', 'aws_confluence_page.csv')
    # Set the output file
...
def main():
    ...
    if options.pageid:
        ...
        pageid = 222389323 # Main AWS EC2 instances page
